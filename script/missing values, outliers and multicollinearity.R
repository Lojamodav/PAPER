...
str(datos)
#we remove 
Hake<-subset(Hake,Hake$Sex!=3)
#We define sex
datos$SEXO <- factor(Hake$ex, 
...
Knm<-na.ma(Knm) #replace missing values with movil medians  con 
...
Knh<-tsclean(Knh)
Knh
boxplot.stats(Knh)$out
tsoutliers::tso(ts(Knh,start=1982))#at?pico en la posici?n 17 y 34
...
colnames(dfha)<-c("year", "AMO", "NAO","SST","Kn","BIO","SSB_length")
...
boxplot(L50_Male)
tsoutliers::tso(ts(L50_Male,start=1982))
...
36 +47+	40+	41+	45+	59+	60+	63	+40+	51+	60+	69+	75+	75+	76+	89+	76+
  82+	77+	73+	91+	74+	74+	90+	73+	81+	81+	100+	66+	59+	77+	84+	70+	75+	56+	57
+64+	75+	78+	70+	57+	51+	68+	58+	74+	70+	72+	66+	82+	70+	61+	64+	58+	56+	46+	60+
  68+	81+	88+	88+	58+	69+	64+	65+	41+	51+	47+	43+	30+	26+	22+	25+	16+	15+	15+	10+	6	+10+	5	+7+	4+	7+	10
